document.addEventListener("DOMContentLoaded", function() {
    ...
    const info = window.smartphoneSpecs[modelKey].info;
    ...
    if (document.getElementById("info-screen")) document.getElementById("info-screen").innerHTML = '<b>Screen:</b> ' + info.InfoScreen;
    if (document.getElementById("info-processor")) document.getElementById("info-processor").innerHTML = '<b>Processor:</b> ' + info.InfoProcessor;
    if (document.getElementById("info-graphics")) document.getElementById("info-graphics").innerHTML = '<b>Graphics:</b> ' + info.InfoGraphics;
    if (document.getElementById("info-camera")) document.getElementById("info-camera").innerHTML = '<b>Camera:</b> ' + info.InfoCamera;
    if (document.getElementById("info-battery")) document.getElementById("info-battery").innerHTML = '<b>Battery:</b> ' + info.InfoBattery;
    if (document.getElementById("info-weight")) document.getElementById("info-weight").innerHTML = '<b>Weight:</b> ' + info.InfoWeight;
    if (document.getElementById("info-release-date")) document.getElementById("info-release-date").innerHTML = '<b>Release date:</b> ' + info.InfoReleaseDate;
    if (document.getElementById("info-price")) document.getElementById("info-price").innerHTML = '<b>Price:</b> ' + info.InfoPrice;
...
window.smartphoneSpecs = {
    "apple-iphone-16-pro-max": {
        info: {
            InfoScreen: "6.9\" OLED - 1320 x 2868",
            InfoProcessor: "Apple A18 Pro",
            InfoGraphics: "Apple A18 Pro GPU",
            InfoCamera: "3 (48 MP + 12 MP + 48 MP)",
            InfoBattery: "4685 mAh",
            InfoWeight: "227 grams (8.01 oz)",
            InfoReleaseDate: "September 2024",
            InfoPrice: "$1,199"
        },
